...
from qai_hub_models.models.convnext_v2_base import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.convnext_v2_base.export` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models export convnext_v2_base` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
